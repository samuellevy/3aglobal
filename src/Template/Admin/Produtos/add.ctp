        ...
        <div class="content">
          <?= $this->Form->create($produto) ?>
            <div class="row">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  <?php echo $this->Form->control('tipo', ['class'=>'form-control', 'label'=>'Tipo','options' => $tipos]); ?>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-4">
                <div class="form-group">
                  <?php echo $this->Form->control('recorrencia', ['class'=>'form-control', 'label'=>'Recorrência', 'options' => $options_recorrencia]); ?>
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-group">
