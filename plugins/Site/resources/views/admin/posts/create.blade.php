...
@section('main')
    {!! Form::open([
            'url' => 'admin/posts', 'method' => 'POST', 'class' => 'form',
        ...
        <fieldset>
            ...
            <div class="form-group">
                ...
                <div class="file-block no-upload">
                    <input type="text" name="image_id" id="hidden-image_id" required style="display: none">
                    <img alt="Selecionar imagem&hellip;" class="preview open-modal" id="image_id" data-href="{{ url('admin/midia/selecionar') }}">
                </div>
            </div>
            <div class="row">
